...
description: "Planning, itinerary, and logs for expedition [number]."
tags:
  - expedition
  - travel
  - planning
  - "[destination]"
  - "[trip-type]"
status: "planning" # planning | upcoming | completed | aborted
dates: "[Start Date] - [End Date]"
---

# Expedition [number]

<!-- This table provides a high-level summary of the trip's characteristics. -->
| Field         | Value                          |
|---------------|--------------------------------|
| **Purpose**   | `[e.g., Cultural, Adventure]`  |
| **Duration**  | `[e.g., Week-Long Vacation]`   |
| **Style**     | `[e.g., Mid-Range, Luxury]`    |
| **Size**      | `[e.g., Solo, Couple]`         |
| **Environment** | `[e.g., Urban, Mountain]`      |

---

## Phase 1: Conception & High-Level Plan

<!-- Define the core requirements and constraints for the trip. -->

*   **Purpose:** [What are the main goals or inspirations for this trip?]
    *   [Goal 1]
    *   [Goal 2]
*   **Duration:** [What is the wanted duration of the trip? e.g., "7-10 days"]
*   **Size:** [Who is traveling? e.g., Solo, Couple, Family (2 adults, 2 children)]
*   **Available Date Ranges:** [List all possible date ranges for the trip.]
    *   [Range 1: e.g., June 10 - June 25, 2024]
    *   [Range 2: e.g., September 1 - September 15, 2024 (around holiday)]
*   **Flight Parameters:**
    *   **Budget:** [e.g., $400 – $700 per person]
    *   **Company:** [`Specific Company` or `Any`]
    *   **Home → Destination:**
        *   Preferred Takeoff Window: [e.g., 06:00 – 10:00]
        *   Preferred Landing Window: [e.g., 09:00 – 13:00]
    *   **Destination → Home:**
        *   Preferred Takeoff Window: [e.g., 16:00 – 20:00]
        *   Preferred Landing Window: [e.g., 19:00 – 23:00]
...
<!-- Use the parameters from Phase 1 to find and list all eligible flights from sources like Skyscanner, Google Flights, etc. -->

| Dates        | Airline   | Outbound (Depart-Arrive) | Inbound (Depart-Arrive) | Price | Link      | Notes                  |
|--------------|-----------|--------------------------|-------------------------|-------|-----------|------------------------|
| [Date Range] | [Airline] | [Time] - [Time]          | [Time] - [Time]         | [$]   | [URL]     | [e.g., Long layover]   |
| [Date Range] | [Airline] | [Time] - [Time]          | [Time] - [Time]         | [$]   | [URL]     | [e.g., Direct flight]  |
| [Date Range] | [Airline] | [Time] - [Time]          | [Time] - [Time]         | [$]   | [URL]     |                        |
...
<!-- Announce the final choice and begin detailed planning for that single destination. -->
...
<!-- A day-by-day breakdown of the plan. -->
